...
<template>
  <div class="view-page">
    <header class="page-head"><div><p class="eyebrow">一人有尽，山河无穷</p><h1>天下</h1><p>玄历 {{ game.state.world.currentYear }} 年 · {{ game.state.world.eraName }}纪元</p></div><div class="calligraphy">界</div></header>
